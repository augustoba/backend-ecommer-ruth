...
/**
 * Una fila por cada cambio de stock de un talle — auditoría de qué pasó, no
 * sólo el número actual. Se registra desde un único punto
 * ({@link com.estilospequenos.service.ProductService#decrementStock}/{@code
 * incrementStock}/{@code setStock}) para que ningún caller se pueda olvidar.
 */
@Entity
