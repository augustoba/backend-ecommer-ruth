...
import com.saasweb.core.dashboard.MetricsDtos.ComparisonResponse;
import com.saasweb.core.dashboard.MetricsDtos.GroupBreakdown;
import com.saasweb.core.dashboard.MetricsDtos.GroupRow;
import com.saasweb.core.dashboard.MetricsDtos.MetricsResponse;
import com.saasweb.core.dashboard.MetricsDtos.MonthBucket;
import com.saasweb.core.dashboard.MetricsDtos.PeriodStat;
import com.saasweb.core.dashboard.MetricsDtos.ProductStat;
import com.saasweb.core.dashboard.MetricsDtos.Totals;
import com.saasweb.core.dashboard.MetricsDtos.WeekWindow;
...
public class MetricsService {
    ...
    public MetricsResponse compute(LocalDate from, LocalDate to, String groupBy) {
        ...
        for (Order o : orders) {
            ...
            Acc channelAcc = o.getChannel() == com.saasweb.core.order.SaleChannel.LOCAL ? localAcc : webAcc;
    ...
    private List<com.saasweb.core.dashboard.MetricsDtos.GroupRow> sizeRows(Map<String, Acc> bySize) {
        return bySize.entrySet().stream()
                ...
                .map(en -> new com.saasweb.core.dashboard.MetricsDtos.GroupRow(
    ...
    private List<com.saasweb.core.dashboard.MetricsDtos.GroupRow> supplierRows(Map<String, Acc> bySupplier) {
