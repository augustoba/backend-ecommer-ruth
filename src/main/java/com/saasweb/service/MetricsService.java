...
import com.saasweb.dto.MetricsDtos.MetricsResponse;
import com.saasweb.dto.MetricsDtos.MonthBucket;
import com.saasweb.dto.MetricsDtos.PeriodStat;
import com.saasweb.dto.MetricsDtos.ProductStat;
import com.saasweb.dto.MetricsDtos.Totals;
import com.saasweb.dto.MetricsDtos.WeekWindow;
import com.saasweb.model.Order;
import com.saasweb.model.OrderLine;
...
import com.saasweb.model.ProductParam;
import com.saasweb.model.Exchange;
import com.saasweb.model.Supplier;
import com.saasweb.repository.ExchangeRepository;
import com.saasweb.repository.OrderRepository;
import com.saasweb.repository.ParamRepository;
...
public class MetricsService {
    ...
    public MetricsResponse compute(LocalDate from, LocalDate to, String groupBy) {
        ...
        for (Order o : orders) {
            ...
            Acc channelAcc = o.getChannel() == com.saasweb.model.SaleChannel.LOCAL ? localAcc : webAcc;
        ...
        return new MetricsResponse(
                ...
                new com.saasweb.dto.MetricsDtos.ChannelBreakdown(
    ...
    private List<com.saasweb.dto.MetricsDtos.GroupRow> sizeRows(Map<String, Acc> bySize) {
        return bySize.entrySet().stream()
                ...
                .map(en -> new com.saasweb.dto.MetricsDtos.GroupRow(
